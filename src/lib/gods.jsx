...
export const GODS = [
  ...
  { key: 'apollo', god: 'Apollo', color: '#fbbf24', Icon: p => (
  ...
  { key: 'ares', god: 'Ares', color: '#f87171', Icon: p => (
  ...
  { key: 'achilles', god: 'Achilles', color: '#d97706', Icon: p => (
  ...
  { key: 'odysseus', god: 'Odysseus', color: '#34d399', Icon: p => (
  ...
  { key: 'hermes', god: 'Hermes', color: '#a78bfa', Icon: p => (
  ...
  { key: 'hephaestus', god: 'Hephaestus', color: '#fb923c', Icon: p => (
  ...
  { key: 'hades', god: 'Hades', color: '#818cf8', Icon: p => (
  ...
  { key: 'perseus', god: 'Perseus', color: '#67e8f9', Icon: p => (
  ...
  { key: 'dionysus', god: 'Dionysus', color: '#e879f9', Icon: p => (
  ...
  { key: 'pan', god: 'Pan', color: '#a3e635', Icon: p => (
  ...
  { key: 'morpheus', god: 'Morpheus', color: '#818cf8', Icon: p => (
  ...
  { key: 'atlas', god: 'Atlas', color: '#9ca3af', Icon: p => (
  ...
  { key: 'athena', god: 'Athena', color: '#93c5fd', Icon: p => (
...
export function godOf(player) {
  ...
  return (key && godByKey(key)) || { key: null, god: 'Titan', color: '#94a3b8', Icon: p => <svg viewBox="0 0 24 24" {...p}><path fill="currentColor" d="M4 20V9l8-5 8 5v11h-3v-6H7v6H4z" /></svg> }
}
    ...
    <span style={{ display: 'inline-flex', alignItems: 'center', gap: 8 }}>
      ...
      {showName && (
        <span style={{ lineHeight: 1.2 }}>
          ...
          <span className="small mute" style={{ display: 'block', fontSize: 11 }}>{g.god}</span>
        </span>
      )}
    </span>
  )
