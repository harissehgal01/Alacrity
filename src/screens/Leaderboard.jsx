...
export default function Leaderboard({ players, perfs, openProfile, online = new Set(), profiles = [] }) {
  ...
  const leaders = useMemo(() => {
    ...
    let mostKills = null, topGameDmg = null, bestKda = null, topNetWorth = null, topBuilding = null, mostAssists = null, topCamps = null
    ...
    return { mostKills, topGameDmg, bestKda, topNetWorth, topBuilding, mostAssists, topCamps }
  }, [stats, players])
  ...
  return (
    <>
      <div className="leaders">
        ...
        {leaders.topCamps && <div className="leader"><div className="k">Camps stacked · game</div><div className="v num">{leaders.topCamps.v}</div><div className="who">{leaders.topCamps.who}</div></div>}
      </div>
